"use strict";
var jsxRuntime = require("react/jsx-runtime"), csm = require("@sanity/client/csm"), previewKitCompat = require("@sanity/preview-kit-compat"), mendoza = require("mendoza"), require$$0 = require("react"), context = require("./context.cjs"), s = { 0: 8203, 1: 8204, 2: 8205, 3: 8290, 4: 8291, 5: 8288, 6: 65279, 7: 8289, 8: 119155, 9: 119156, a: 119157, b: 119158, c: 119159, d: 119160, e: 119161, f: 119162 }, c = { 0: 8203, 1: 8204, 2: 8205, 3: 65279 };
...
class LRUCache {
  ...
  static unsafeExposeInternals(c2) {
    return {
      ...
      backgroundFetch: (k, index, options, context2) => c2.#backgroundFetch(k, index, options, context2),
  ...
  *rvalues() {
  ...
  async fetch(k, fetchOptions = {}) {
    ...
    if (index === void 0) {
      ...
      const p = this.#backgroundFetch(k, index, options, context2), staleVal = p.__staleWhileFetching !== void 0 && allowStale;
  ...
  memo(k, memoOptions = {}) {
    ...
    const { context: context2, forceRefresh, ...options } = memoOptions, v = this.get(k, options);
...
function LiveStoreProvider(props) {
  ...
  const [client] = require$$0.useState(() => {
  ...
  const [subscriptions, setSubscriptions] = require$$0.useState([]), [snapshots] = require$$0.useState(() => /* @__PURE__ */ new Map()), hooks = useHooks(setSubscriptions), [context$1] = require$$0.useState(() => function(initialSnapshot, query, params) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(context.defineStoreContext.Provider, { value: context$1, children: [
    children,
...
function QuerySubscription(props) {
  const { client, refreshInterval, query, params, listeners, snapshots, turboIdsFromSourceMap } = props, { projectId, dataset } = require$$0.useMemo(() => {
  ...
  const [revalidate, startRefresh] = previewKitCompat.useRevalidate({ refreshInterval }), shouldRefetch = revalidate === "refresh" || revalidate === "inflight";
...
function Turbo(props) {
  const { client, snapshots, cache, turboIds, setTurboIds, docsInUse } = props, { projectId, dataset } = require$$0.useMemo(() => {
    const { projectId: projectId2, dataset: dataset2 } = client.config();
    return { projectId: projectId2, dataset: dataset2 };
  }, [client]);
  require$$0.useEffect(() => {
  ...
  }, [cache, setTurboIds, snapshots, turboIds, docsInUse]), previewKitCompat.useDocumentsInUse(docsInUse, projectId, dataset);
  ...
  }, [cache, dataset, lastMutatedDocumentId, projectId, snapshots, turboIds]), /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: batch.map((ids) => /* @__PURE__ */ jsxRuntime.jsx(
    GetDocuments,
    {
      client,
      projectId,
